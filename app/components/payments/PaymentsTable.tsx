...
// Keep the type loose; we only read common fields
type AnyPayment = {
  id: string;
  created_at?: string;
...
export default function PaymentsTable({
  ...
  payments?: AnyPayment[] | null;
}) {
  const [selected, setSelected] = useState<AnyPayment | null>(null);

  // ✅ Hard guard against undefined/null/anything non-array
  const rows: AnyPayment[] = useMemo(
