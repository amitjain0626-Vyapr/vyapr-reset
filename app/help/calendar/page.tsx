  ...
  return (
    <main className="mx-auto max-w-2xl p-6 space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Linking your Google Calendar lets Vyapr auto-block booked slots and avoid double bookings.
      </p>

      <ol className="list-decimal pl-5 space-y-2 text-sm">
        <li>From the dashboard, if you see the yellow banner, click <span className="font-medium">Connect Calendar</span>.</li>
        <li>Choose <span className="font-medium">Continue with Google</span> and allow access when asked.</li>
      ...
      <div className="rounded-xl border p-4 bg-gray-50 text-sm">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Test push: open the three-dots menu on a lead and use <em>Add to Calendar</em>.</li>
        </ul>
      </div>
