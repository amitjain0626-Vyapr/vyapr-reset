...
export async function generateMetadata(props: any) {
  ...
  const description = p?.bio || `Book and pay easily with ${BRAND.name}.`;
  ...
  return {
    ...
    openGraph: { title, description, url, type: "website", siteName: BRAND.name, images },
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Show badge only when verified AND published
