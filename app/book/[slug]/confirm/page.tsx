...
const SITE = BRAND.baseUrl; // centralized
...
function buildWa(
  ...
  const msg = encodeURIComponent(
    `Hi ${providerName || "there"}, I’d like to ${act}. Reference: ${lid || "—"} (via ${BRAND.name} ${absUrl(
      `/book/${slug}`
    )}).`
  );
...
export default async function Page({
  ...
  searchParams: Promise<{ lid?: string; amt?: string; svc?: string }>;
}) {
